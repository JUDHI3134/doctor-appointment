...
const MyProfile = () => {
  ...
  const [userData,setUserData] = useState({
    name:"Judhistir Behera",
    image:assets.profile_pic,
    email:"judhistirb19@gmail.com",
    phone:"+91 9090161171",
    address:{
      line1:"Markona, Balasore",
      line2:"Odisha, India, 756134"
    },
    gender:"Male",
    dob:"1999-05-16"
  })
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      {
        isEdit ? <input className='text-3xl bg-gray-50 font-medium max-w-60 mt-4' type="text" value={userData.name} onChange={e => setUserData(prev => ({...prev,name: e.target.value}))} /> 
